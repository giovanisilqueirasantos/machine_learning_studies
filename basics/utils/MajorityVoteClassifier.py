...
class MajorityVoteClassifier(BaseEstimator, ClassifierMixin):
    """
        ...
        parameters
        ----------
        classifiers: array-lie, shape = [n_classifiers]
            Diferent classifiers for the ensemble
        
        vote: str, {'classlabel', 'probability'}
            Default: 'classlabel'
            if 'classlabel' the prediction is based on
            the argmax of class labels. Else if 'probability',
            the armax of the sum of probabilities is used to predict
    ...
    def fit(self, X, y):
        ...
        # with 0, witch is important for np.argmax
